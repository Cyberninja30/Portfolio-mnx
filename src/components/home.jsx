      ...
      <div className="terminal-container">
        <header className="terminal-header">
          <div className="terminal-prompt pulse-glow">
            root@kali-mnx~#<span className="terminal-cursor" />
          </div>
          <nav className="terminal-nav">
            <Link to="/timeline">🕒timeline </Link>
            <Link to="/projects">💼projects</Link>
            <Link to="/skills">🛠️skills</Link>
            <Link to="/certifications">🏆achievements</Link>
            <a href="/Resume_Moinak.pdf" download="Moinak_Resume.pdf" target="_blank" rel="noopener noreferrer">📄resume.pdf</a>
          </nav>
        </header>
        ...
        <section id="About">
          ...
          <div className="profile-section">
            ...
            <div className="profile-info">
              ...
              <br />
              <p>Intern @<strong className="pulse-glow">Haryana Police Cyber Cell</strong> </p>
