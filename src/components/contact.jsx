    ...
    return (
      <section id="contact" className="connect-section">
        ...
        <div className="social-links">
          ...
          <span style={{ color: 'var(--terminal-muted)' }}>·</span>
          <a href="https://www.reddit.com/user/FaithlessnessNo4481/" target="_blank" rel="noopener noreferer">Reddit</a>
          <span style={{color: 'var(--terminal-muted'}}>.</span>
          <a href="mailto:moinak@albussec.com">Email</a>
        </div>
        <div style={{ marginTop: 30, color: 'var(--terminal-muted)', fontSize: '0.9rem' }}>
          <p>No system is unbreakable. Only resilient, ethical, and aware. Stay curious. Stay secure.</p>
